...
<body>
	<center>
		...
		<ul class="nav-links">
			<li class="center"><a href="index.jsp"><svg
  ...
  <path
			...
			<li class="center"><a href="ContactUs.jsp"><svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <path
			...
			<li class="center"><a href="AboutUs.jsp"><svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <path d="M8 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
			...
			<li class="center"><a href="UserLoginView.jsp"><svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
						fill="currentColor" class="bi bi-clipboard2-check-fill"
						viewBox="0 0 16 16">
  <path
